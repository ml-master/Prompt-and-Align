...
for iter in range(iterations):
    acc, prec, recall, f1, test_acc_real, test_acc_rumor = train_model(args,
    ...
    f1_all.append(f1)
    test_accs_reals.append(test_acc_real)
    test_accs_rumors.append(test_acc_rumor)
...
print("Final: Test Acc real:{} | Test Acc rumor:{}".format(sum(test_accs_reals)/iterations, sum(test_accs_rumors)/iterations))


with open('logs/' +  datasetname + '_fewshot_' + str(args.n_samples) + '_samples_' + args.model_name + '_t' + str(user_threshold) + '.' + 'iter' + str(iterations), 'w+') as f:
    ...
    f.write('\n')
    f.write("Final: Test Acc real:{} | Test Acc rumor:{}".format(sum(test_accs_reals)/iterations, sum(test_accs_rumors)/iterations))
